      ...
      <div class="col-md-4 col-md-offset-4">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <form accept-charset="UTF-8" role="form" method="POST" action="registro.proc.php">
                    <fieldset>
                <div class="form-group">
                  <input class="form-control" placeholder="Tu Nombre" name="nombre" type="text" required>
              </div> 
              <div class="form-group">
                  <input class="form-control" placeholder="Tu Apellido" name="ape" type="text" required>
              </div>    
