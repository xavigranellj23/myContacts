...
$sql_perfil = "SELECT * FROM tbl_contactos WHERE $_SESSION[id_contacto] = id_usuario";
      ...
      <div id="barraNegra">
        <div id="barraLogin">
          <ul id="listaLogin">
            ...
            <li><a href="desloguerase.php"><img src="img/exit.png" alt="Salir" title="Salir" /></a></li>
          </ul>
        </div>
      </div>
...
<section id="centro">
            ...
            <table>
                  ...
                  <tr>
                    ...
                    <td style="width:300px"><br/><input type="text" name="nom" size="15" maxlength="25" value="<?php echo $mostrar['apellido_usu']; ?>"><br/></td>
                    <td style="width:300px"><br/><input type="text" name="nom" size="15" maxlength="25" value="<?php echo $mostrar['email_usu']; ?>"><br/></td>
                    <td style="width:300px"><br/><input type="text" name="nom" size="15" maxlength="25" value="<?php echo md5($mostrar['passwd_usu']); ?>"><br/></td>
